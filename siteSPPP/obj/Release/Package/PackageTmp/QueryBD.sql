...
VALUES ('CARTERA DE PROYECTOS FISE')
...
ALTER TABLE NOTICIAS ALTER COLUMN CONTENIDO nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AI
	/*Tipos: 
	1 = Capturista
	2 = Administrador
...
db name: sitio_sepla
	*/
	...
	SELECT * FROM ARCHIVOS
	update TIPO_PLANTILLA
	set TIPOPLANTILLA = 'MARCO REGULATORIO'
	WHERE IDTIPO=6
